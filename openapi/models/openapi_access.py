...
class Access(models.Model):
    ...
    # @api.constrains('read_one_id')
    # def _check_read_one_fields(self):
    #     if not self.read_one_id:
    #         return
    #     try:
    #         self.read_one_id._check_fields()
    #     except Exception as e:
    #         raise e
    #
    # @api.constrains('read_many_id')
    # def _check_read_many_fields(self):
    #     if not self.read_many_id:
    #         return
    #     try:
    #         self.read_many_id._check_fields()
    #     except Exception as e:
    #      raise e
    ...
    def get_OAS_paths_part(self):
        ...
        if self.api_public_methods or self.public_methods or self.private_methods:
            ...
            if self.api_public_methods:
                ...
                allowed_methods += [m for m in self.public_methods if m]
            if self.private_methods:
                allowed_methods += [m for m in self.private_methods if m]

            params_definition_one = "#/definitions/MethodParams-single_record"
            params_definition_many = "#/definitions/MethodParams-recordset"
            ...
            for method_name in allowed_methods:
                ...
                paths_object[read_one_path_method] = {
                    'patch': {
                        ...
                        "responses": {
                            ...
                            # TODO: think about other statuses
                        }
                    }
                }
                ...
                paths_object[read_many_path_method] = {
                    'patch': {
                        ...
                        # TODO: https://stackoverflow.com/questions/582056/getting-list-of-parameter-names-inside-python-function
                        "parameters": [
                            {
                                "in": "body",
                                "name": "body",
...
class AccessCreateContext(models.Model):
    ...
    def _check_context(self):
        ...
        for record in self:
            ...
            # TODO: add validating for values
